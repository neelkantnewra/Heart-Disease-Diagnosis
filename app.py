...
def heartDiseasePredictor():
    if request.method == 'POST':
        ...
        element = sc.transform([[age,gender,chest_pain_type,resting_blood_pressure,serum_cholestrol_value,fasting_blood_sugar,resting_ecg,heart_rate_value,induced_agina,st_depression_value,peak_exercise_st]])
